      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title m-b-40 mt-3 align-self-center">Add Product</h5>
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 flotleft">
                    <div class="field" align="left">
                      ...
                      <span class="col-md-12 note flotright m-t-20">Image Size <span class="green">width 350</span> * <span class="green">height 250</span></span>
                  </div>
                      ...
                      <div class="form-wrap form-wrap2">
                          ...
                          <div class="col-sm-12 col-xs-12">
                            <div class="form-group m-b-15">
                              ...
                              <div>
                                <input type="text" name="title" class="form-control font-14"  placeholder="Name">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group m-b-15">
                            <div class="row m-0 m-b-20">
                              <div class="col-md-12 col-xs-12 m-b-5">
                                <label class="control-label font-14 m-b-5">Select Type</label>
                                <div>
                                  <select class="custom-select font-14 m-b-5" name="type" data-style="btn-default btn-outline">
                                    ...
                                    <option  data-tokens="Category" value="import"> Import </option>
                                    <option  data-tokens="Category" value="export"> Export </option>
                                  </select>
                                </div>
                              </div>
                            </div>
