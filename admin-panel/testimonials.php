...
$clientResult = $TestimonialController->GetAll();
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex m-b-10 no-block">
                  <h5 class="card-title m-b-0 align-self-center"><i class="flaticon-file"></i> Testimonials <span class="label label-rounded label-primary ml-auto">15</span></h5>

                  <div class="ml-auto text-light-blue">
                    <ul class="nav nav-tabs customtab default-customtab list-inline text-uppercase lp-5 font-medium font-12" role="tablist">
                                <li>
                      <a href="add-testimonial.php" class="btn waves-effect waves-light btn-rounded btn-primary">Add</a>
                      </li>
                      </ul>
                  </div>
                </div>
...
while ($record = $clientResult->fetch_assoc()) {?>
                        ...
                        <td><?=$record['client_message'];?></td>
                        <td class="text-center"><a href="testimonials-edit.php?id=<?=$record['id'];?>"><i class="fas fa-pencil-alt"></i></a></td>
                        <td class="text-center"><a href="testimonials-delete.php?id=<?=$record['id'];?>"><i class="fas fa-trash-alt text-danger"></i></a></td>
                      </tr>
