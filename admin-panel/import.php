            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex m-b-10 no-block">
                  <h5 class="card-title m-b-0 align-self-center"><i class="fas fa-book"></i> Import <span class="label label-rounded label-primary ml-auto"><?=$totalImportProducts;?></span></h5>
                </div>
                      ...
                      <tr>
                        ...
                        <td><?=$import['description'];?></td>
                         <td class="text-center"><a href="edit.php?id=<?=$import['id'];?>">
                          ...
                          <td class="text-center"><a href="delete-product.php?id=<?=$import['id'];?>"><i class="fas fa-trash-alt text-danger"></i></a></td>
                      </tr>
                      <?php }
?>
                    </tbody>
