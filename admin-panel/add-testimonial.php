      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title m-b-40 mt-3 align-self-center">Add Testimonials</h5>
                <div class="row">
                  <!-- End of product slider -->
                  <div class="col-lg-12 col-md-12">
                    <div class="row">
                      <div class="form-wrap form-wrap2 mt-4">
                        <form class="form-horizontal" method="post" action="<?=$clientApi;?>">
                          <input type="hidden" name="formAction" value="post">
                          <div class="col-sm-12 col-xs-12">
                            <div class="form-group m-b-15 full">
                              <label class="control-label text-primary font-12 m-b-5">Client Name</label>
                              <div>
                                <input type="text" name="client_name" class="form-control font-14" placeholder="Name">
                              </div>
                            </div>
                          </div>
                           ...
                           <div class="col-sm-12 col-xs-12">
                            <div class="form-group m-b-15 full">
                              ...
                              <div><!--
                                ...
                                <textarea type="text" name="client_message" class="form-control font-14" placeholder="Name"></textarea>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col-md-12  col-xs-12 text-right">
                              <div class="p-l-15 p-r-15">
                                <span class="buttonname">
                                  <!-- <label>Save</label> -->
                                  <input class="inputbut" type="submit" name="submit" value="Submit">
                                </span>
                              </div>
                            </div>
                          </div>
